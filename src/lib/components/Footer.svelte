<footer class="bg-black border-t border-gray-800 mt-auto relative overflow-hidden">
  <!-- Background pattern -->
  ...
  <div class="container mx-auto px-4 py-12 relative z-10">
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <!-- Quick Links -->
      <div>
        <h3 class="font-bold text-gym-red mb-4 tracking-wider uppercase">Quick Links</h3>
        <ul class="space-y-2">
          <li>
            <a href="/about" class="text-gray-400 hover:text-gym-red transition-colors inline-flex items-center gap-2 group">
